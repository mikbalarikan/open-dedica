...
| `OD-H01` ULKA EP5 pump: modeled | `OD-H11` Thermoblock: modeled | `OD-H24` Flowmeter: modeled | `OD-H22` 3-way valve: modeled | `OD-G04` Brewing gasket support: modeled |
|---|---|---|---|---|
...
| [report](../step/reports/OD-H01_ulka_ep5_pump/) | [report](../step/reports/OD-H11_thermoblock/) | [report](../step/reports/OD-H24_flowmeter/) | [report](../step/reports/OD-H22_3way_valve/) | [report](../step/reports/OD-G04_brewing_gasket_support/) |
...
Next up: check-fixtures for `OD-H01`, `OD-H11`, `OD-H24`, `OD-H22` and `OD-G04` (stage 4). Every part still marked `open` in stage 1 needs someone with the part to scan it. See [CONTRIBUTING.md](../CONTRIBUTING.md).
